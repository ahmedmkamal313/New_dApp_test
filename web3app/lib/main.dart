...
void main() {
  runApp(
    ChangeNotifierProvider<WalletProvider>(
      create: (context) => WalletProvider(), // Creating an instance of WalletProvider.
...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return MaterialApp(
      ...
      theme: ThemeData(
        colorScheme: ColorScheme.fromSeed(seedColor: Colors.deepPurple), // Setting a color scheme.
            ...
            children: [
              ElevatedButton(
                onPressed: () async {
                  ...
                  final publickKey = await walletProvider.getPublicKey(privateKey);
